...
"treecats" stands for "tree categories." Yes, the package and its name is inspired by Hadley Wickham's [`forcats`](http://forcats.tidyverse.org/). The logo comes from John Tenniel's classic illustrations to *Alice's Adventures in Wonderland*.
