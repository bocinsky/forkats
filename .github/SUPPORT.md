# Getting help with treecats

Thanks for using treecats. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/treecats/issues) to make sure the 
